...
FlickrConnector = {
    ...
    '<div style="padding-top:10px; padding-bottom: 10px; cursor: pointer;" class="place-go">' +
    '<img src="{{properties.url}}" style="width: 100%;"></div>',
    ...
    fetch: function (url, placeCallback, finishedCallback) {
        ...
        url = 'https://api.flickr.com/services/rest/?method=flickr.photosets.getPhotos&api_key=6b15ed9c00eddca7b6686293bdaad8e6&photoset_id='+this.config.photoset+'&user_id='+this.config.user+'&extras=geo,url_m,url_t,url_s,date_taken&per_page=50&page=1&format=json&jsoncallback=?';
